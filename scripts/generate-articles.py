#!/usr/bin/env python3
"""
Generate articles.md from the Dev Leader Google PageSpeed Insights MCP tag page.
...
_TAG_URL = 'https://www.devleader.ca/tags/GooglePsiMcp'
...
def generate_markdown(articles: list[dict]) -> str:
    ...
    lines = [
        ...
        "",
        "!!! tip \"Stay Updated\"",
        "    Follow [Dev Leader](https://www.devleader.ca) for articles about MCP servers, Google PageSpeed Insights, Core Web Vitals, and C#/.NET development.",
        "",
    ]
